...
def run_inference(model_path: str, source: Any, save_results: bool = True) -> List[Results]:
    ...
    # TODO: Run inference on the input source using the model's .predict() method
    # Ensure the save option is mapped to save_results.
    
    # TODO: Return the list of Results objects
    pass
