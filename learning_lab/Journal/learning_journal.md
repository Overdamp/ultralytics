...
| :--- | :--- | :--- | :--- |
| 2026-07-05 | Created and indexed [[experiments/05_advanced_yolo/EX65_Analog_Gauge_Reader/EX65_Analog_Gauge_Reader_TH\|EX65-EX74 Advanced YOLO]] case studies | Designed and wrote detailed Markdown lesson guides (EN & TH) for real-world computer vision engineering challenges, including analog gauge readers, LPR systems, safety PPE compliance audits, crowd density mappings, high-res web inspection with SAHI, Siamese retail product databases, Kalman filter sports ball tracking, Inverse Perspective IPM projections, segment agricultural grading, and thermal-sensor fire alarm validation feeds. | Prepare code skeletons, solutions, and notebooks for the advanced cases. |
| 2026-07-05 | Created and implemented [[experiments/04_basic_yolo/EX51_YOLO_CLI/EX51_YOLO_CLI_TH\|EX51-EX64 Basic YOLO]] modules | Populated Python skeletons, solutions, and Jupyter explanation notebooks (EN & TH) for YOLO CLI, model configs, training settings, evaluation modes, prediction sources, output box parsing, exports, multi-task heads, streaming inference generators, dataset layouts, visualizers, object trackers, and callbacks. | Begin baseline custom training on PTT dataset. |
